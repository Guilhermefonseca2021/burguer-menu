  ...
  return (
    <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        {/* <div className="flex flex-col items-center md:flex-row">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-2">HP Victus Gaming Laptop</h1>
            <p className="text-sm text-gray-600 mb-4">Intel Core i5 12th Gen 12450H - (8 GB/512 GB SSD/Windows 11 Home/4 GB Graphics/NVIDIA GeForce RTX 2050)</p>
